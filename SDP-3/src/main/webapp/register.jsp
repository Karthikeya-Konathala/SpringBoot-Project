...
<body>
    <header class="text-gray-600 body-font">
      ...
      <section class="text-gray-600 body-font">
        <form method="post" action="/login" ModelAttribute="reg">
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
          ...
          <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <div class="relative mb-4">
              ...
              <input name="name" type="text" id="Name" name="Name" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="relative mb-4">
            ...
            <div class="relative mb-4">
              ...
              <input name="cpswd" type="password" id="CPassword" name="CPassword" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
           <a href = "./login.jsp"><button type="submit" onclick="save()" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Candidate Sign Up</button></a> 
